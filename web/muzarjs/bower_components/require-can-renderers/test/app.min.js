...
define("init_preload", ["can/view/ejs"], function() { can.view.preload("init", can.EJS(function(_CONTEXT,_VIEW) { with(_VIEW) { with (_CONTEXT) {var ___v1ew = [];___v1ew.push("Hello World.");; return ___v1ew.join('')}} })) });
define("ejs!init", ["can/view/ejs"], function(can) { return can.EJS(function(_CONTEXT,_VIEW) { with(_VIEW) { with (_CONTEXT) {var ___v1ew = [];___v1ew.push("Hello World.");; return ___v1ew.join('')}} })});
define("views/foo_preload", ["can/view/ejs"], function() { can.view.preload("views_foo", can.EJS(function(_CONTEXT,_VIEW) { with(_VIEW) { with (_CONTEXT) {var ___v1ew = [];___v1ew.push(can.view.txt(1,'',0,this,function(){ return  this.attr('time') }));; return ___v1ew.join('')}} })) });
define("ejs!views/foo", ["can/view/ejs"], function(can) { return can.EJS(function(_CONTEXT,_VIEW) { with(_VIEW) { with (_CONTEXT) {var ___v1ew = [];___v1ew.push(can.view.txt(1,'',0,this,function(){ return  this.attr('time') }));; return ___v1ew.join('')}} })});
/*!
* CanJS - 1.1.5 (2013-03-27)
* http://canjs.us/
* Copyright (c) 2013 Bitovi
